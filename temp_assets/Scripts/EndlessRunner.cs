...
//path generation  left,right,stright.
...
public class PathGeneration : MonoBehaviour
{
    ...
    void generatePath()
    {
        for (int i = 0; i < pathLength; i++)
        {
            ...
            GameObject tile = Instantiate(tiles[randomIndex], nextSpawnPosition, Quaternion.identity);
            nextSpawnPosition += new Vector3(0, 0, tile.transform.localScale.z);
        }
    }
